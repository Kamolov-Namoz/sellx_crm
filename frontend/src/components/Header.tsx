    ...
    <header className="bg-[#17212b] sticky top-0 z-40 safe-top border-b border-[#242f3d]">
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-white">{title || 'Sales CRM'}</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={logout}
            className="p-2 text-gray-400 hover:text-white hover:bg-[#242f3d] rounded-full transition-colors"
            title="Chiqish"
          >
